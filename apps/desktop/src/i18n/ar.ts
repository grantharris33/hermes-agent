...
export const ar = defineLocale({
  ...
  sidebar: {
    ...
    projects: {
      ...
      ideaLabel: 'الفكرة',
      ideaPlaceholder: 'ما موضوع هذا المشروع؟ (يُحفظ كملاحظات للمشروع وفي IDEA.md)',
      ideaGenerate: 'توليد فكرة',
      ideaGenerating: 'جار التوليد...',
      ideaShuffle: 'خلط القوالب',
      guidanceLabel: 'إرشادات المشروع',
      guidancePlaceholder: 'تعليمات الوكيل في هذا المشروع (يبقى AGENTS.md في المستودع الأكثر تخصيصًا)',
