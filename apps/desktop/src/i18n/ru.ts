...
export const ru = defineLocale({
  ...
  sidebar: {
    ...
    projects: {
      ...
      foldersLabel: 'Папки',
      ideaLabel: 'Идея',
      ideaPlaceholder: 'О чём этот проект? (сохраняется в заметках проекта и IDEA.md)',
      ideaGenerate: 'Сгенерировать идею',
      ideaGenerating: 'Генерация…',
      ideaShuffle: 'Перемешать шаблоны',
      guidanceLabel: 'Инструкции проекта',
      guidancePlaceholder: 'Инструкции агенту для этого проекта (AGENTS.md в репозитории имеет приоритет)',
